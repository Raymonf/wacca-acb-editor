...
from atom_types.file.utf_file import Utf_File, UtfField
...
class Utf:
    ...
    def set(self, row: int, columnName: str, value, constant = False):
        ...
        if column.types.column == "constant" and not constant:
            raise ValueError(f"set() used on constant field '{columnName}' but argument 'constant' is {constant}. Set 'constant' to True to set as constant.")
        elif column.types.column == "variable" and constant:
            raise ValueError(f"set() used on non-constant field '{columnName}' but argument 'constant' is {constant}. Set 'constant' to False to set as variable.")
